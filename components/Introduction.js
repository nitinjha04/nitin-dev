    ...
    >
      ...
      >
        <Stack isInline spacing={4}>
          <Link href="https://github.com/nitinjha04" isExternal>
            <Button
              pos="static"
              color="white"
          ...
          <Link href="https://linkedin.com/in/jhanitin" isExternal>
            <Button
              pos="static"
              color="white"
          ...
          <Link href="mailto:nitinjha890@gmail.com" isExternal>
            <Button
              pos="static"
              color="white"
              transition="0.3s"
